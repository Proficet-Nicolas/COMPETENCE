...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 25 fév. 2021 à 23:41
...
(57, 'blalblabla', '2021-02-10', 'oui oui caaaaa looooo ', '2021-02-18', 21, 'semaine(s)', 0, 3, 2),
(59, 'bnd,;ajmklsdzajl', '2021-02-12', 'djqzkljdilqz', '2021-02-18', 23, 'mois', 0, 3, 2);
...
--
ALTER TABLE `liens`
  MODIFY `id_liens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT pour la table `situation`
--
ALTER TABLE `situation`
  MODIFY `id_situation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
